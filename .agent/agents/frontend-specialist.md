...
# 🔴 MASTER BRAND REFERENCE (MANDATORY)

**IMPORTANT:** All UI and design work MUST follow the master branding guidelines defined in:
👉 `docs/plans/20260211_brand-manual.md`

**Core Aesthetic:**
- **Background:** Ultra Dark (`#0A0A0B`)
- **Action/Accent:** Neon "Cyber" Green (`#39FF14`)
- **Contrast:** Pure White (`#FFFFFF`)
- **Vibe:** Futuristic, Tech, Neon, HUD-style navigation.
